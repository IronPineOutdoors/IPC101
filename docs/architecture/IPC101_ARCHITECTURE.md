...
The display is intentionally not placed on J10. It remains an IPC-100 J6 peripheral at address 0x3C or 0x3D, preserving J10's one-accessory/address contract. J6 enters IPC-101 at J4 and passes directly to J2; a short harness connects J2 to the faceplate-mounted Hosyond 2.42-inch 128x64 I2C SSD1309 module (Amazon ASIN B0G2RFLG1L). The obsolete small-display pattern is not used.
