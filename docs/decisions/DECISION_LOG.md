...
| D-007 | Keep OLED on dedicated IPC-100 J6; use Hosyond 2.42-inch SSD1309 B0G2RFLG1L as the prototype candidate. | Preserves display power/reset contract and one-accessory J10 rule; sample qualification is required before mechanical release. | Accepted with qualification hold |
