...
| D-007 | Keep OLED on dedicated IPC-100 J6 electrically, terminating it through IPC-101 J4/J2; use Hosyond 2.42-inch SSD1309 B0G2RFLG1L as the prototype candidate. | Makes IPC-101 the removable control-panel hub while preserving the display power/reset contract and J10 rule. | Accepted with qualification hold |
