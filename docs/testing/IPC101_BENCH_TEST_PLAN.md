...
8. **OLED:** inspect the Hosyond B0G2RFLG1L module's printed pin order and RESET population before making the keyed J6-to-2.54 mm harness. With current-limited 3.3 V power, confirm address 0x3C or 0x3D, reset control, startup, all-pixel pattern, orientation, contrast, current (listing claims 52 mA maximum), pull-up/rise-time compatibility, and unpowered I/O backfeed behavior.
