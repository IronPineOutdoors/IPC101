...
8. **OLED:** inspect the Hosyond B0G2RFLG1L module's printed pin order and RESET population before making the J6-to-J4 and J2-to-module harnesses. Continuity-check J4 pin 1 through J2 pin 1, through all five positions, with no cross-connections or connection to J1. With current-limited 3.3 V power, confirm address 0x3C or 0x3D, reset control, startup, all-pixel pattern, orientation, contrast, current (listing claims 52 mA maximum), pull-up/rise-time compatibility, and unpowered I/O backfeed behavior.
