...
if __name__=='__main__':
    ...
    path=asset(g.ROOT, 'CrossWind_IPC101_P504_Clearance_R1_8mm_PRINT.stl')
    ...
    (asset(g.ROOT, 'P504_clearance_R1_verification.json')).write_text(json.dumps(report,indent=2)+'\n')
