...
**Update: the user confirmed the hole edge is the restriction.** The [N1.4 full faceplate](../../faceplate/REV_N14_FACEPLATE.md) now includes the 8 mm aperture. CAD checks pass; physical directional travel remains unverified. The coupon below remains available for a smaller test.
