...
The [N1.2 tree correction](../../faceplate/history/REV_N12_FACEPLATE.md) supersedes the generic tree in N1.1. R1 cap geometry is unchanged.
...
- [N1.2 white faceplate](../../faceplate/history/CrossWind_IPC101_Faceplate_RevN12_WHITE_PETGHF.stl)
- [N1.2 black inlay](../../faceplate/history/CrossWind_IPC101_Faceplate_RevN12_BLACK_AMS.stl)
...
```powershell
python -B mechanical/enclosure/tooling/render_button_caps_r1.py --openscad "C:\path\to\openscad.com"
python -B mechanical/enclosure/tooling/render_faceplate_n1.py --revision N12 --openscad "C:\path\to\openscad.com"
python -B mechanical/enclosure/tooling/verify_button_caps_r1.py
python -B mechanical/enclosure/tooling/preview_button_caps_r1.py
```
