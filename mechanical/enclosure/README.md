# Crosswind IPC-101 control box Rev E
...
Use `CrossWind_IPC101_Control_Box_RevE_PRINT.stl` for slicing. The installed-orientation STL is supplied for assembly checks and CAD visualization. Rev D is obsolete because two faceplate nut traps and two rear mounting screws were obstructed.
