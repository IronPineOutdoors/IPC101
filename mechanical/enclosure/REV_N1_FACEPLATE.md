...
```powershell
python -B mechanical/enclosure/render_faceplate_n1.py --openscad "C:\path\to\openscad.com"
python -B mechanical/enclosure/verify_faceplate_n1.py
python -B mechanical/enclosure/verify_rev_i1.py
python -B mechanical/enclosure/preview_faceplate_n1.py
```
