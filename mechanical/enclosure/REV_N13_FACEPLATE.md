...
```powershell
python -B mechanical/enclosure/render_faceplate_n1.py --revision N13 --openscad "C:\path\to\openscad.com"
python -B mechanical/enclosure/verify_faceplate_n13.py
python -B mechanical/enclosure/preview_faceplate_n13.py
```
