"""Actual R1 two-color cap meshes on the matching N1.1 faceplate."""
...
views=[('R1 ARM FACE LABEL',front,single('ARM')),
       ...
       ('N1.1 PANEL WITH LABELED CAPS',front,plate_parts+cap_parts),
...
body=body.replace('GREY SHELL   TAN CRADLE   DARK R3   GREEN PCB   IVORY BEZEL AND FACEPLATE','R1 CAPS   FLUSH TWO COLOR LABELS   N1.1 FACEPLATE HAS NO DUPLICATE BUTTON TEXT')
