...
- [Panel with R1 caps](../../controls/buttons/R1_button_caps_preview.png)
...
python -B mechanical/enclosure/tooling/verify_faceplate_n12.py
python -B mechanical/enclosure/tooling/verify_button_caps_r1.py
python -B mechanical/enclosure/tooling/preview_faceplate_n12.py
