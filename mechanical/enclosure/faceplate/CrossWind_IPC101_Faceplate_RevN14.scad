...
// N1.4: operator-view button positions measured on the physical PCB.
...
module cuts(){
 ...
 // Enlarged after physical report: hole edge blocks P504 directions.
 translate([nav[0],nav[1],-.5])cylinder(h=3,d=8.0);
...
module raw_white(){
 ...
 text("IPC101-FP-N1.4",size=3,font="Liberation Sans:style=Bold",halign="center");}
}
