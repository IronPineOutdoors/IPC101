...
colors={'Box':(150,160,168),'Cradle':(180,151,114),'R3':(104,116,128),'PCB':(106,147,125),'Bezel':(215,206,186),'Faceplate':(232,225,209),'Bracket':(103,111,124),'Wiring':(187,188,182),'Hardware':(73,78,83)}
...
assembly=[('Box',box),('Cradle',cradle),('R3',r3),('Bezel',bezel),('PCB',pcb),('Faceplate',plate),('Bracket',bracket),('Wiring',g.h.build_port_plate()),('Hardware',g.face(bolts))]
...
views=[('OPEN SHELL AND SEATS',(1,2,1.6),[('Box',box)]),
       ...
       ('EXPLODED FRONT SERVICE',(1.4,2,1.5),[('Box',box),('Bracket',bracket.translate((0,-25,0))),('Cradle',g.face(g.cradle_local().translate((0,0,-30)))),('R3',g.face(g.r3_local().translate((0,0,-50)))),('PCB',g.face(g.pcb_local().translate((0,0,-70)))),('Bezel',g.face(g.bezel_local().translate((0,0,-90)))),('Faceplate',g.face(g.plate_local().translate((0,0,-110))))]),
